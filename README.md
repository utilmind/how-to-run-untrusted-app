# How to run untusted React/Node.js project via Docker

## Pre-requisites (e.g. on Windows)
1. Docker Desktop — https://www.docker.com/products/docker-desktop/

## Process
1. Install Docker Desktop.
2. Create a new file, `Dockerfile` in the root of the project, with the following content:
